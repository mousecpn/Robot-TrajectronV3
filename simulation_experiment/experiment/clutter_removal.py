...
import io as sysio
import os
from utils_exp import io
from utils_exp.grasp import *
...
def run(
    ...
    for _ in tqdm.tqdm(range(num_rounds), disable=silence):
        ...
        while sim.num_objects > 0 and consecutive_failures < MAX_CONSECUTIVE_FAILURES and skip_time < 3:
            trial_id += 1
            timings = {}
